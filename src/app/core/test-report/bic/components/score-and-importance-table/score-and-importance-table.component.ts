...
@Component({
  selector: 'app-score-and-importance-table',
  templateUrl: './score-and-importance-table.component.html',
  styleUrls: ['../concept-definitions/concept-definitions.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class ScoreAndImportanceTableComponent extends BicLocalFiltersComponent<GroupedBarDataSet> implements OnChanges {
